...
#    path('manage_dispe/<str:pk>/',pharmacistViews.dispenseDrug,name='pharm_disp'),
    ...
    # path('receptionist/billing/', clerkViews.billing, name='billing_create'),
    path('receptionist/billing/', clerkViews.BillingListView.as_view(), name='billing_list'),
    path('receptionist/billing/create/', clerkViews.BillingCreateView.as_view(), name='billing_create'),
    path('pdf/', clerkViews.pdf_view, name='pdf_view'),
