...
class Billing(models.Model):
    ...
    tablet = models.CharField(max_length=2000,null=True,blank=True)
    quantity = models.CharField(max_length=2000,null=True,blank=True)
...
class Stock(models.Model):
    ...
    drug_imprint=models.CharField(max_length=50 ,blank=True, null=True)
...
class Dispense(models.Model):
    ...
    drug_name = models.CharField(max_length=300, null=True, blank=False)
